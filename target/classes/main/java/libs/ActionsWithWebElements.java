...
public class ActionsWithWebElements {
    ...
    public void selectDropDownInsideIframeAndClick(String iFrameXpath, WebElement element, WebElement element2, String addButtonXpath, String itemName) {
        try {
            ...
            Select dropDownValue2 = new Select(element2);
            webDriverWait10.until(ExpectedConditions.visibilityOf(element2));
            dropDownValue2.selectByVisibleText(itemName);
