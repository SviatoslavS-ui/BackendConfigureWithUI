...
public class BonusManagementPage extends ParentPage {
    ...
    @FindBy(xpath = "//select[@name='ucCompBrandsList$drpLstBrands']")
    private WebElement brandDropDown2;
    ...
    public void selectBrandDropDown() {
        try {
            ...
            actionsElements.selectDropDownInsideIframeAndClick(iFrameXpath, brandDropDown, brandDropDown2, addButtonXpath, selectBrandItem);
